<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 w-full">
            ...
            <a href="{{ route('appointments.create') }}" class="inline-flex items-center bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded shadow-md transition duration-150 ease-in-out whitespace-nowrap">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($appointments as $appointment)
                                    <tr>
                                        <td class="px-6 py-4">{{ $appointment->patient->first_name ?? $appointment->patient->name }} {{ $appointment->patient->last_name }}</td>
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ route('appointments.edit', $appointment) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Uredi</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 text-center text-gray-500">Nema termina</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
